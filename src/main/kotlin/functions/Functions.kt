...
//    - функтор (контейнер с функцией, модификации валуе) - map
//    - моноид (множество объектов; 1. есть нейтральный элемент. 2. комбинирование 3. не ассоциативное) - 0:числа:операция сложения; 1:числа:умножение
//    - монада (моноид + операция bind(flatMap)) - позволяет связать монады.
//    - аплекатив (комбинирует ф-ции в контейнере! Содержит метод комбинирования)
//    - альтернатив
